 ...
 * значение больше нуля - увеличение громкости за счет увеличения значения
 * предусиления, аттеньютатор == 0;
 * значение меньше нуля - уменьшение громкости за счет увеличения значения
 * аттеньютора; предусиление == 0;
